	...
	<div class="module_border">
		...
		<div class="c">
			{literal}
				...
				{/literal}
                <div>
                    <input type="checkbox" {if $pur.attestation_all === true}checked{/if} name="purview[]" value="attestation_all" />认证管理权限
                    <input type="checkbox" {if $pur.borrow_all === true}checked{/if} name="purview[]" value="borrow_all" />借款管理权限
                    <input type="checkbox" {if $pur.account_all === true}checked{/if} name="purview[]" value="account_all" />资金管理权限
                    <input type="checkbox" {if $pur.integral_all === true}checked{/if} name="purview[]" value="integral_all" />积分管理权限
                    <input type="checkbox" {if $pur.userinfo_all === true}checked{/if} name="purview[]" value="userinfo_all" />用户信息管理权限
                    <input type="checkbox" {if $pur.content_all === true}checked{/if} name="purview[]" value="content_all" />内容管理权限
                    <input type="checkbox" {if $pur.bbs_all === true}checked{/if} name="purview[]" value="bbs_all" />论坛管理权限
                    <input type="checkbox" {if $pur.other_all === true}checked{/if} name="purview[]" value="other_all" />所有权限
                </div>
