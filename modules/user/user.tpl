...
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	...
	<tr>
	  ...
	  {/literal}
			...
			<div class="floatr">
				用户名：<input type="text" name="keywords" id="keywords" value="{$magic.request.keywords|urldecode}"/>  邮箱：<input type="text" name="email" id="email" value="{$magic.request.email|urldecode}"/>  真实姓名：<input type="text" name="realname" id="realname" value="{$magic.request.realname|urldecode}"/> <input type="button" value="搜索" / onclick="sousuo()">
			</div>
			</td>
		</tr>
	<tr>
