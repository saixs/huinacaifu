...
<table  border="0"  cellspacing="1" bgcolor="#CCCCCC" width="100%">
	<tr >
		<td class="main_td">上线用户名</td>
		<td class="main_td">下线用户名</td>
		<td class="main_td">注册时间</td>
		<td class="main_td">提成</td>
	</tr>
	{list  module="referrals" function="GetFriendsInvite" var="loop"  showpage="3"}
