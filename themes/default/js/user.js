...
//检验注册
function userReg(){
	var check=document.getElementsByName("reg_agreement"); 
...
a=false; 
document.getElementById('agree_notice').innerHTML = agree_msg;
document.forms['formUser'].elements['Submit'].disabled = '';
} 
else{ 
a=true;
...
var username_msg = '* 4-15位字符.英文,数字';
var username_msg_exist = "* 已经存在,请重新输入";
...
var password_msg_shorter = "* 不能少于 6 个字符。";
var password_msg_confirm_invalid = "* 两次输入密码不一致";
var realname_msg_empty = "* 真实姓名不能为空";
var realname_msg_len = "* 不能少于2个汉字";
var realname_msg_chn = "* 真实姓名只能为汉字";
var realname_msg_war = "* 姓氏是错误的"; 
var agree_msg = "<font color=red>*请接受我们的条款！</font>"
/* 会员修改密码 */
